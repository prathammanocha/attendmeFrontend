...
@Component({
  selector: 'app-relativesdialog',
  templateUrl: './relativesdialog.component.html',
  styleUrls: ['./relativesdialog.component.css']
})
export class RelativesdialogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, 
    ...
    private dialogRef: MatDialogRef<RelativesdialogComponent>) { }
