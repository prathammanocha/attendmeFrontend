...
@Component({
  selector: 'app-parentsdialog',
  templateUrl: './parentsdialog.component.html',
  styleUrls: ['./parentsdialog.component.css']
})
export class ParentsdialogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, 
    ...
    private dialogRef: MatDialogRef<ParentsdialogComponent>) { }
